      ...
      >
        <SwiperSlide>
          <div
            ...
            style={{
              backgroundImage: `url(/images/main-banner-image/banner-new-bg4.jpg)`,
            }}
          >
        ...
        <SwiperSlide>
          <div
            className="main-banner"
            style={{
              backgroundImage: `url(/images/main-banner-image/banner-new-bg5.jpg)`,
            }}
          >
            <div className="d-table">
              <div className="d-table-cell">
        ...
        <SwiperSlide>
          <div
            className="main-banner"
            style={{
              backgroundImage: `url(/images/main-banner-image/banner-new-bg6.jpg)`,
            }}
          >
            <div className="d-table">
              <div className="d-table-cell">
