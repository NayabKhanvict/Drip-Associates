              ...
              <div className="single-product-box single-product-two">
                <div className="product-image">
                  <Link href="/products/product-details/">
                    <img
                      src="/images/grocery/grocery-product1.jpg"
                      alt="image"
                    />
                    <img
                      src="/images/grocery/grocery-product1.jpg"
                ...
                <div className="product-content">
                  <h3>
                    <Link href="/products/product-details/">Beef Meat</Link>
                  </h3>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-product-box single-product-two">
                <div className="product-image">
                  <Link href="/products/product-details/">
                    <img
                      src="/images/grocery/grocery-product2.jpg"
                      alt="image"
                    />
                    <img
                      src="/images/grocery/grocery-product2.jpg"
                ...
                <div className="product-content">
                  <h3>
                    <Link href="/products/product-details/">Fresh Chicken</Link>
                  </h3>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-product-box single-product-two">
                <div className="product-image">
                  <Link href="/products/product-details/">
                    <img
                      src="/images/grocery/grocery-product3.jpg"
                      alt="image"
                    />
                    <img
                      src="/images/grocery/grocery-product3.jpg"
                ...
                <div className="product-content">
                  <h3>
                    <Link href="/products/product-details/">Capsicum</Link>
                  </h3>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-product-box single-product-two">
                <div className="product-image">
                  <Link href="/products/product-details/">
                    <img
                      src="/images/grocery/grocery-product4.jpg"
                      alt="image"
                    />
                    <img
                      src="/images/grocery/grocery-product4.jpg"
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-product-box single-product-two">
                <div className="product-image">
                  <Link href="/products/product-details/">
                    <img
                      src="/images/grocery/grocery-product5.jpg"
                      alt="image"
                    />
                    <img
                      src="/images/grocery/grocery-product5.jpg"
                ...
                <div className="product-content">
                  <h3>
                    <Link href="/products/product-details/">Lemon</Link>
                  </h3>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="single-product-box single-product-two">
                <div className="product-image">
                  <Link href="/products/product-details/">
                    <img
                      src="/images/grocery/grocery-product6.jpg"
                      alt="image"
                    />
                    <img
                      src="/images/grocery/grocery-product6.jpg"
                ...
                <div className="product-content">
                  <h3>
                    <Link href="/products/product-details/">Potatoes</Link>
                  </h3>
            ...
            <div className="row align-items-center">
              <div className="col-lg-6 col-md-6">
                <div className="productQuickView-image">
                  <img src="/images/grocery/grocery-product1.jpg" alt="image" />
                </div>
              </div>
              ...
              <div className="col-lg-6 col-md-6">
                <div className="product-content">
                  ...
                  <ul className="product-info">
                    <li>
                      <span>Vendor:</span> <Link href="#">Beef Meat Shop</Link>
                    </li>
                    <li>
                      <span>Availability:</span>{" "}
                      <Link href="#">In stock (700 kg)</Link>
                    </li>
                    <li>
                      <span>Product Type:</span> <Link href="#">Beef</Link>
                    </li>
                  </ul>
